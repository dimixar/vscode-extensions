...
let ActionVisualReflowParagraph_1 = class ActionVisualReflowParagraph extends BaseCommand {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.ModeName.Visual, mode_1.ModeName.VisualLine];
        this.keys = ["g", "q"];
...
let ActionVisualReflowParagraph = ActionVisualReflowParagraph_1;
...
let CommandSurroundAddToReplacement_1 = class CommandSurroundAddToReplacement extends BaseCommand {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.ModeName.SurroundInputMode];
        this.keys = ["<any>"];
...
let CommandSurroundAddToReplacement = CommandSurroundAddToReplacement_1;
